...
```bash
git remote add encore encore://deepshield-platform-kfd2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/deepshield-platform-kfd2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/deepshield-platform-kfd2/settings/integrations/github)
